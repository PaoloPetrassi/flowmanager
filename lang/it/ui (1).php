...
return [
    ...
    'counts' => [
        'companies' => '{1} :count azienda|[2,*] :count aziende',
        'contacts' => '{1} :count contatto|[2,*] :count contatti',
        'projects' => '{1} :count progetto|[2,*] :count progetti',
        'tasks' => '{1} :count attività|[2,*] :count attività',
        'assets' => '{1} :count bene|[2,*] :count beni',
