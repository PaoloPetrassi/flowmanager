...
class SavedFilterController extends Controller
{
    ...
    {
        $d = $r->validate(['resource_type' => 'required|in:companies,contacts,projects,tasks,assets,tickets', 'name' => 'required|string|max:100', 'filters' => 'required|array']);
        auth()->user()->savedFilters()->create($d);
